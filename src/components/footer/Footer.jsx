  ...
  return (
    <footer className='footer'>
      ...
      <div className='footer-right col-md-4 col-sm-6'>
        <div className='footer-final-logo d-flex align-items-center'>
          <img
      ...
      />
      <p>
        sito realizzato a scopo puramente didattico, tutti i diritti
        appartengono alla MARVEL COMICS
      </p>
      <p>Tutte le immagini dei fumetti sono state prese da ReadComicsOnline</p>
    </footer>
  );
};
